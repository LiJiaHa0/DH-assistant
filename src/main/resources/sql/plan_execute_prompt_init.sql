-- ============================================================
-- PlanExecutePrompts 初始化数据
-- 对应 cn.john.dh.assistant.prompt.PlanExecutePrompts 中各常量
-- ============================================================
...
VALUES ('plan_execute', 'plan', '你是【DeepResearch 执行计划规划专家】。
...
-- 2. 任务执行提示词
INSERT INTO `agent_prompt` (`agent_type`, `prompt_key`, `content`, `version`, `status`, `description`)
VALUES ('plan_execute', 'execute', '你是【DeepResearch 工具执行与结果整理专家】。
...
-- 3. 评审提示词
INSERT INTO `agent_prompt` (`agent_type`, `prompt_key`, `content`, `version`, `status`, `description`)
VALUES ('plan_execute', 'critique', '你是【DeepResearch 研究评审专家】。
...
-- 4. 上下文压缩提示词
INSERT INTO `agent_prompt` (`agent_type`, `prompt_key`, `content`, `version`, `status`, `description`)
VALUES ('plan_execute', 'compress', ' 你是【上下文内容压缩器】。
...
-- 5. 研究总结提示词
INSERT INTO `agent_prompt` (`agent_type`, `prompt_key`, `content`, `version`, `status`, `description`)
VALUES ('plan_execute', 'summarize', '你是【DeepResearch 结果总结专家】。
...
-- 6. 需求澄清提示词
INSERT INTO `agent_prompt` (`agent_type`, `prompt_key`, `content`, `version`, `status`, `description`)
VALUES ('plan_execute', 'requirement_clarification', '你是【Deep Research 需求分析专家】，只做需求清晰度判断，不直接解答问题。
...
-- 7. 研究主题生成提示词
INSERT INTO `agent_prompt` (`agent_type`, `prompt_key`, `content`, `version`, `status`, `description`)
VALUES ('plan_execute', 'research_topic_generation', '你是【Deep Research 分析点规划专家】。
